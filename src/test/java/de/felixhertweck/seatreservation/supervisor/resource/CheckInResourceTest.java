...
class CheckInResourceTest {
    ...
    public void setupUserRepositoryMock() {
        ...
        // Mock usernames with reservations for event 10 (two usernames) and for event 20 none
        when(reservationRepository.findDistinctUsernamesByEventId(id(10)))
                .thenReturn(List.of("user1", "user2"));
        when(reservationRepository.findDistinctUsernamesByEventId(id(20))).thenReturn(List.of());
    }
