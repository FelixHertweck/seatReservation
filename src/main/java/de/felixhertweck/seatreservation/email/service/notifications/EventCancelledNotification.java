...
public class EventCancelledNotification extends AbstractUserNotification {

    private final String htmlContent;

    public EventCancelledNotification(User user, String subject, String htmlContent) {
        super(user, subject);
    ...
    public EmailPriority priority() {
        return EmailPriority.TRANSACTIONAL;
    }
}
