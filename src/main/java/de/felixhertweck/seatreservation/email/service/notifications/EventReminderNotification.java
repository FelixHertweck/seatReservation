...
public class EventReminderNotification extends AbstractUserNotification {

    private final String htmlContent;
    private final byte[] seatmapPng;
    private final byte[] qrCode;

    public EventReminderNotification(
            User user, String subject, String htmlContent, byte[] seatmapPng, byte[] qrCode) {
        super(user, subject);
