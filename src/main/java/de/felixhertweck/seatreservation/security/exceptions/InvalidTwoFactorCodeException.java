...
/**
 * Thrown when a sensitive account action (e.g. changing the account email while 2FA is enabled)
 * requires proof of current 2FA possession, but no valid code/backup code was given.
 */
