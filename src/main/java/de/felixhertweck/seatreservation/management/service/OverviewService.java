...
public class OverviewService {
    ...
    public ManagementOverviewDTO getOverview(AuthenticatedUser manager) {
        ...
        // Optimization: Single O(N) iteration instead of multiple .stream().filter() passes
        // Reduces CPU overhead and object creation when processing a large volume of reservations.
