...
public class LayoutAreaDto {
    ...
    @Nullable private List<@Valid CoordinateDTO> boundary;

    public LayoutAreaDto() {}

    public LayoutAreaDto(UUID id, String tempId, String name, List<CoordinateDTO> boundary) {
        this.id = id;
        this.tempId = tempId;
        this.name = name;
