package de.felixhertweck.seatreservation.user.dto;

import java.util.List;

import de.felixhertweck.seatreservation.manager.dto.SeatDTO;
import de.felixhertweck.seatreservation.manager.dto.UserDTO;
