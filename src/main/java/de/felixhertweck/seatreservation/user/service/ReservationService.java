package de.felixhertweck.seatreservation.user.service;
...
import de.felixhertweck.seatreservation.user.NoSeatsAvailableException;
import de.felixhertweck.seatreservation.user.SeatAlreadyReservedException;
