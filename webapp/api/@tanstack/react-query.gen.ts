 ...
 */
export const postApiManagerEventlocationsByIdLayoutOperationsMutation = (options?: Partial<Options<PostApiManagerEventlocationsByIdLayoutOperationsData>>): UseMutationOptions<PostApiManagerEventlocationsByIdLayoutOperationsResponse, DefaultError, Options<PostApiManagerEventlocationsByIdLayoutOperationsData>> => {
    const mutationOptions: UseMutationOptions<PostApiManagerEventlocationsByIdLayoutOperationsResponse, DefaultError, Options<PostApiManagerEventlocationsByIdLayoutOperationsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiManagerEventlocationsByIdLayoutOperations({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiUsersAdminImportResolveMutation = (options?: Partial<Options<PostApiUsersAdminImportResolveData>>): UseMutationOptions<PostApiUsersAdminImportResolveResponse, DefaultError, Options<PostApiUsersAdminImportResolveData>> => {
    const mutationOptions: UseMutationOptions<PostApiUsersAdminImportResolveResponse, DefaultError, Options<PostApiUsersAdminImportResolveData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiUsersAdminImportResolve({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const postApiUsersAdminTagsMutation = (options?: Partial<Options<PostApiUsersAdminTagsData>>): UseMutationOptions<PostApiUsersAdminTagsResponse, DefaultError, Options<PostApiUsersAdminTagsData>> => {
    const mutationOptions: UseMutationOptions<PostApiUsersAdminTagsResponse, DefaultError, Options<PostApiUsersAdminTagsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiUsersAdminTags({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * Add Tag To Users
 */
export const postApiUsersManagerTagsMutation = (options?: Partial<Options<PostApiUsersManagerTagsData>>): UseMutationOptions<PostApiUsersManagerTagsResponse, DefaultError, Options<PostApiUsersManagerTagsData>> => {
    const mutationOptions: UseMutationOptions<PostApiUsersManagerTagsResponse, DefaultError, Options<PostApiUsersManagerTagsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiUsersManagerTags({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
