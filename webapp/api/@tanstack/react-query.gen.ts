...
export const postApiUsersAdminImportQueryKey = (options: Options<PostApiUsersAdminImportData>) => createQueryKey('postApiUsersAdminImport', options);

/**
 * Import Users
 */
export const postApiUsersAdminImportOptions = (options: Options<PostApiUsersAdminImportData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: postApiUsersAdminImportQueryKey(options)
    });
};
