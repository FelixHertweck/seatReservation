...
export const NotificationPageDTOSchema = {
    type: 'object',
    properties: {
        items: {
            type: 'array',
...
export const PushSubscriptionRequestDTOSchema = {
    type: 'object',
    required: [
        'endpoint',
        'p256dh',
...
export const UnreadCountDTOSchema = {
    type: 'object',
    properties: {
        unreadCount: {
            type: 'integer',
...
export const VapidPublicKeyDTOSchema = {
    description: 'VAPID Public Key for browser push registration',
    type: 'object',
    required: [
        'publicKey'
    ],
