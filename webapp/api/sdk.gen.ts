 ...
 */
export const getApiAuthAltchaChallenge = <ThrowOnError extends boolean = false>(options?: Options<GetApiAuthAltchaChallengeData, ThrowOnError>) => (options?.client ?? client).get<GetApiAuthAltchaChallengeResponses, unknown, ThrowOnError>({ url: '/api/auth/altcha-challenge', ...options });
