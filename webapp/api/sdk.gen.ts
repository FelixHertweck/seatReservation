...
export const getApiUserConfirmEmail = <ThrowOnError extends boolean = false>(options?: Options<GetApiUserConfirmEmailData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiUserConfirmEmailResponses, GetApiUserConfirmEmailErrors, ThrowOnError>({
...
export const getApiUserReservationsExportByEventIdCsv = <ThrowOnError extends boolean = false>(options: Options<GetApiUserReservationsExportByEventIdCsvData, ThrowOnError>) => {
    return (options.client ?? client).get<GetApiUserReservationsExportByEventIdCsvResponses, GetApiUserReservationsExportByEventIdCsvErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
