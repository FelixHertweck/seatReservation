 ...
 * Disable Two Factor
 */
export const deleteApiUser2FaDisable = <ThrowOnError extends boolean = false>(options?: Options<DeleteApiUser2FaDisableData, ThrowOnError>): RequestResult<DeleteApiUser2FaDisableResponses, DeleteApiUser2FaDisableErrors, ThrowOnError> => (options?.client ?? client).delete<DeleteApiUser2FaDisableResponses, DeleteApiUser2FaDisableErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Enable Two Factor
 */
export const postApiUser2FaEnable = <ThrowOnError extends boolean = false>(options: Options<PostApiUser2FaEnableData, ThrowOnError>): RequestResult<PostApiUser2FaEnableResponses, PostApiUser2FaEnableErrors, ThrowOnError> => (options.client ?? client).post<PostApiUser2FaEnableResponses, PostApiUser2FaEnableErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Get Settings
 */
export const getApiUser2FaSettings = <ThrowOnError extends boolean = false>(options?: Options<GetApiUser2FaSettingsData, ThrowOnError>): RequestResult<GetApiUser2FaSettingsResponses, GetApiUser2FaSettingsErrors, ThrowOnError> => (options?.client ?? client).get<GetApiUser2FaSettingsResponses, GetApiUser2FaSettingsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Update Settings
 */
export const putApiUser2FaSettings = <ThrowOnError extends boolean = false>(options: Options<PutApiUser2FaSettingsData, ThrowOnError>): RequestResult<PutApiUser2FaSettingsResponses, PutApiUser2FaSettingsErrors, ThrowOnError> => (options.client ?? client).put<PutApiUser2FaSettingsResponses, PutApiUser2FaSettingsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/user/2fa/settings',
    ...options,
    headers: {
 ...
 * Setup Totp
 */
export const postApiUser2FaSetupTotp = <ThrowOnError extends boolean = false>(options?: Options<PostApiUser2FaSetupTotpData, ThrowOnError>): RequestResult<PostApiUser2FaSetupTotpResponses, PostApiUser2FaSetupTotpErrors, ThrowOnError> => (options?.client ?? client).post<PostApiUser2FaSetupTotpResponses, PostApiUser2FaSetupTotpErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
