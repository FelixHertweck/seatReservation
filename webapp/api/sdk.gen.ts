 ...
 */
export const postApiManagerEventlocationsRegister = <ThrowOnError extends boolean = false>(options: Options<PostApiManagerEventlocationsRegisterData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiManagerEventlocationsRegisterResponses, PostApiManagerEventlocationsRegisterErrors, ThrowOnError>({
        responseTransformer: postApiManagerEventlocationsRegisterResponseTransformer,
        security: [
            {
                scheme: 'bearer',
                type: 'http'
