...
import type { PostApiAuthLoginData, PostApiAuthLoginResponses, PostApiAuthLoginErrors, PostApiAuthLogoutData, PostApiAuthLogoutResponses, PostApiAuthRegisterData, PostApiAuthRegisterResponses, PostApiAuthRegisterErrors, GetApiManagerEventlocationsData, GetApiManagerEventlocationsResponses, GetApiManagerEventlocationsErrors, PostApiManagerEventlocationsData, PostApiManagerEventlocationsResponses, PostApiManagerEventlocationsErrors, PostApiManagerEventlocationsImportData, PostApiManagerEventlocationsImportResponses, PostApiManagerEventlocationsImportErrors, PostApiManagerEventlocationsImportByIdData, PostApiManagerEventlocationsImportByIdResponses, PostApiManagerEventlocationsImportByIdErrors, DeleteApiManagerEventlocationsByIdData, DeleteApiManagerEventlocationsByIdResponses, DeleteApiManagerEventlocationsByIdErrors, PutApiManagerEventlocationsByIdData, PutApiManagerEventlocationsByIdResponses, PutApiManagerEventlocationsByIdErrors, GetApiManagerEventsData, GetApiManagerEventsResponses, GetApiManagerEventsErrors, PostApiManagerEventsData, PostApiManagerEventsResponses, PostApiManagerEventsErrors, DeleteApiManagerEventsByIdData, DeleteApiManagerEventsByIdResponses, DeleteApiManagerEventsByIdErrors, GetApiManagerEventsByIdData, GetApiManagerEventsByIdResponses, GetApiManagerEventsByIdErrors, PutApiManagerEventsByIdData, PutApiManagerEventsByIdResponses, PutApiManagerEventsByIdErrors, GetApiManagerReservationAllowanceData, GetApiManagerReservationAllowanceResponses, GetApiManagerReservationAllowanceErrors, PostApiManagerReservationAllowanceData, PostApiManagerReservationAllowanceResponses, PostApiManagerReservationAllowanceErrors, PutApiManagerReservationAllowanceData, PutApiManagerReservationAllowanceResponses, PutApiManagerReservationAllowanceErrors, GetApiManagerReservationAllowanceEventByEventIdData, GetApiManagerReservationAllowanceEventByEventIdResponses, GetApiManagerReservationAllowanceEventByEventIdErrors, DeleteApiManagerReservationAllowanceByIdData, DeleteApiManagerReservationAllowanceByIdResponses, DeleteApiManagerReservationAllowanceByIdErrors, GetApiManagerReservationAllowanceByIdData, GetApiManagerReservationAllowanceByIdResponses, GetApiManagerReservationAllowanceByIdErrors, GetApiManagerReservationsData, GetApiManagerReservationsResponses, GetApiManagerReservationsErrors, PostApiManagerReservationsData, PostApiManagerReservationsResponses, PostApiManagerReservationsErrors, PostApiManagerReservationsBlockData, PostApiManagerReservationsBlockResponses, PostApiManagerReservationsBlockErrors, GetApiManagerReservationsEventByIdData, GetApiManagerReservationsEventByIdResponses, GetApiManagerReservationsEventByIdErrors, DeleteApiManagerReservationsByIdData, DeleteApiManagerReservationsByIdResponses, DeleteApiManagerReservationsByIdErrors, GetApiManagerReservationsByIdData, GetApiManagerReservationsByIdResponses, GetApiManagerReservationsByIdErrors, GetApiManagerSeatsData, GetApiManagerSeatsResponses, GetApiManagerSeatsErrors, PostApiManagerSeatsData, PostApiManagerSeatsResponses, PostApiManagerSeatsErrors, DeleteApiManagerSeatsByIdData, DeleteApiManagerSeatsByIdResponses, DeleteApiManagerSeatsByIdErrors, GetApiManagerSeatsByIdData, GetApiManagerSeatsByIdResponses, GetApiManagerSeatsByIdErrors, PutApiManagerSeatsByIdData, PutApiManagerSeatsByIdResponses, PutApiManagerSeatsByIdErrors, GetApiUserConfirmEmailData, GetApiUserConfirmEmailResponses, GetApiUserConfirmEmailErrors, GetApiUserEventsData, GetApiUserEventsResponses, GetApiUserEventsErrors, PostApiUserResendEmailConfirmationData, PostApiUserResendEmailConfirmationResponses, PostApiUserResendEmailConfirmationErrors, GetApiUserReservationsData, GetApiUserReservationsResponses, GetApiUserReservationsErrors, PostApiUserReservationsData, PostApiUserReservationsResponses, PostApiUserReservationsErrors, GetApiUserReservationsExportByEventIdCsvData, GetApiUserReservationsExportByEventIdCsvResponses, GetApiUserReservationsExportByEventIdCsvErrors, DeleteApiUserReservationsByIdData, DeleteApiUserReservationsByIdResponses, DeleteApiUserReservationsByIdErrors, GetApiUserReservationsByIdData, GetApiUserReservationsByIdResponses, GetApiUserReservationsByIdErrors, GetApiUsersAdminData, GetApiUsersAdminResponses, GetApiUsersAdminErrors, PostApiUsersAdminData, PostApiUsersAdminResponses, PostApiUsersAdminErrors, PostApiUsersAdminImportData, PostApiUsersAdminImportResponses, PostApiUsersAdminImportErrors, DeleteApiUsersAdminByIdData, DeleteApiUsersAdminByIdResponses, DeleteApiUsersAdminByIdErrors, PutApiUsersAdminByIdData, PutApiUsersAdminByIdResponses, PutApiUsersAdminByIdErrors, GetApiUsersManagerData, GetApiUsersManagerResponses, GetApiUsersManagerErrors, GetApiUsersMeData, GetApiUsersMeResponses, GetApiUsersMeErrors, PutApiUsersMeData, PutApiUsersMeResponses, PutApiUsersMeErrors, GetApiUsersRolesData, GetApiUsersRolesResponses, GetApiUsersRolesErrors } from './types.gen';
import { client as _heyApiClient } from './client.gen';
import { getApiManagerEventlocationsResponseTransformer, postApiManagerEventlocationsResponseTransformer, postApiManagerEventlocationsImportResponseTransformer, postApiManagerEventlocationsImportByIdResponseTransformer, putApiManagerEventlocationsByIdResponseTransformer, getApiManagerEventsResponseTransformer, getApiManagerEventsByIdResponseTransformer, putApiManagerEventsByIdResponseTransformer, getApiManagerReservationAllowanceResponseTransformer, postApiManagerReservationAllowanceResponseTransformer, putApiManagerReservationAllowanceResponseTransformer, getApiManagerReservationAllowanceEventByEventIdResponseTransformer, getApiManagerReservationAllowanceByIdResponseTransformer, getApiManagerReservationsResponseTransformer, postApiManagerReservationsBlockResponseTransformer, getApiManagerReservationsEventByIdResponseTransformer, getApiManagerReservationsByIdResponseTransformer, getApiManagerSeatsResponseTransformer, getApiManagerSeatsByIdResponseTransformer, putApiManagerSeatsByIdResponseTransformer, getApiUserEventsResponseTransformer, getApiUserReservationsResponseTransformer, getApiUserReservationsByIdResponseTransformer, getApiUsersAdminResponseTransformer, postApiUsersAdminImportResponseTransformer, putApiUsersAdminByIdResponseTransformer, getApiUsersManagerResponseTransformer, getApiUsersMeResponseTransformer, putApiUsersMeResponseTransformer } from './transformers.gen';
...
export const postApiManagerEventlocationsImport = <ThrowOnError extends boolean = false>(options: Options<PostApiManagerEventlocationsImportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiManagerEventlocationsImportResponses, PostApiManagerEventlocationsImportErrors, ThrowOnError>({
...
export const postApiManagerEventlocationsImportById = <ThrowOnError extends boolean = false>(options: Options<PostApiManagerEventlocationsImportByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiManagerEventlocationsImportByIdResponses, PostApiManagerEventlocationsImportByIdErrors, ThrowOnError>({
...
export const deleteApiManagerEventsById = <ThrowOnError extends boolean = false>(options: Options<DeleteApiManagerEventsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiManagerEventsByIdResponses, DeleteApiManagerEventsByIdErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiManagerEventsById = <ThrowOnError extends boolean = false>(options: Options<GetApiManagerEventsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiManagerEventsByIdResponses, GetApiManagerEventsByIdErrors, ThrowOnError>({
...
export const getApiManagerReservationAllowance = <ThrowOnError extends boolean = false>(options?: Options<GetApiManagerReservationAllowanceData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiManagerReservationAllowanceResponses, GetApiManagerReservationAllowanceErrors, ThrowOnError>({
...
export const putApiManagerReservationAllowance = <ThrowOnError extends boolean = false>(options: Options<PutApiManagerReservationAllowanceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutApiManagerReservationAllowanceResponses, PutApiManagerReservationAllowanceErrors, ThrowOnError>({
...
export const getApiManagerReservationAllowanceEventByEventId = <ThrowOnError extends boolean = false>(options: Options<GetApiManagerReservationAllowanceEventByEventIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiManagerReservationAllowanceEventByEventIdResponses, GetApiManagerReservationAllowanceEventByEventIdErrors, ThrowOnError>({
...
export const deleteApiManagerReservationAllowanceById = <ThrowOnError extends boolean = false>(options: Options<DeleteApiManagerReservationAllowanceByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteApiManagerReservationAllowanceByIdResponses, DeleteApiManagerReservationAllowanceByIdErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const postApiManagerReservationsBlock = <ThrowOnError extends boolean = false>(options: Options<PostApiManagerReservationsBlockData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiManagerReservationsBlockResponses, PostApiManagerReservationsBlockErrors, ThrowOnError>({
...
export const postApiUserResendEmailConfirmation = <ThrowOnError extends boolean = false>(options?: Options<PostApiUserResendEmailConfirmationData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostApiUserResendEmailConfirmationResponses, PostApiUserResendEmailConfirmationErrors, ThrowOnError>({
 ...
 */
export const getApiUserReservationsExportByEventIdCsv = <ThrowOnError extends boolean = false>(options: Options<GetApiUserReservationsExportByEventIdCsvData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUserReservationsExportByEventIdCsvResponses, GetApiUserReservationsExportByEventIdCsvErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getApiUsersAdmin = <ThrowOnError extends boolean = false>(options?: Options<GetApiUsersAdminData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetApiUsersAdminResponses, GetApiUsersAdminErrors, ThrowOnError>({
...
export const postApiUsersAdminImport = <ThrowOnError extends boolean = false>(options: Options<PostApiUsersAdminImportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiUsersAdminImportResponses, PostApiUsersAdminImportErrors, ThrowOnError>({
