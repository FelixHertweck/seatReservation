...
>(({ className, noX = false, ...props }, ref) => (
  <BaseDialogContent
    ...
    className={cn(
      ...
      "sm:inset-auto sm:top-[50%] sm:left-[50%] sm:grid sm:h-auto sm:max-h-[85vh] sm:w-full sm:max-w-xl sm:-translate-x-1/2 sm:-translate-y-1/2 sm:overflow-y-auto sm:rounded-lg sm:border sm:p-6",
