...
export function LocationFormModal({
  ...
  const venueChanged =
    !isCreating &&
    location &&
    (formData.name !== location.name || formData.address !== location.address);
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder={t(
                    "management.locations.form.addressPlaceholder",
                  )}
                  required
                />
              </div>
      ...
      {showConfirmModal && (
        <AlertDialog open={showConfirmModal} onOpenChange={setShowConfirmModal}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>
                {location?.hasEventsWithActiveBooking
                  ? t("management.locations.warningActiveBookingTitle")
                  : t("management.locations.confirmVenueChangeTitle")}
              </AlertDialogTitle>
              <AlertDialogDescription>
                {location?.hasEventsWithActiveBooking
                  ? t("management.locations.warningActiveBookingDescription")
                  : t("management.locations.confirmVenueChangeDescription")}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={doSubmit} disabled={isLoading}>
                {t("common.confirm")}
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
