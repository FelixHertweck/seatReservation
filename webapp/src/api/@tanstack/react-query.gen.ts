...
export const getApiUserEventsAvailableReservationsByEventIdQueryKey = (options: Options<GetApiUserEventsAvailableReservationsByEventIdData>) => createQueryKey('getApiUserEventsAvailableReservationsByEventId', options);

/**
 * Get Available Reservations
 */
export const getApiUserEventsAvailableReservationsByEventIdOptions = (options: Options<GetApiUserEventsAvailableReservationsByEventIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiUserEventsAvailableReservationsByEventId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiUserEventsAvailableReservationsByEventIdQueryKey(options)
    });
};

export const getApiUserEventsAvailableSeatsByEventIdQueryKey = (options: Options<GetApiUserEventsAvailableSeatsByEventIdData>) => createQueryKey('getApiUserEventsAvailableSeatsByEventId', options);

/**
 * Get Available Seats
 */
export const getApiUserEventsAvailableSeatsByEventIdOptions = (options: Options<GetApiUserEventsAvailableSeatsByEventIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiUserEventsAvailableSeatsByEventId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiUserEventsAvailableSeatsByEventIdQueryKey(options)
    });
};
