 ...
 */
export const getApiUserEventsAvailableReservationsById = <ThrowOnError extends boolean = false>(options: Options<GetApiUserEventsAvailableReservationsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiUserEventsAvailableReservationsByIdResponses, GetApiUserEventsAvailableReservationsByIdErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
