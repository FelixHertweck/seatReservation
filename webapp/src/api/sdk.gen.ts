 ...
 */
export const postApiEmailSendHello = <ThrowOnError extends boolean = false>(options: Options<PostApiEmailSendHelloData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiEmailSendHelloResponses, PostApiEmailSendHelloErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
