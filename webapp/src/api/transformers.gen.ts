...
import type { GetApiManagerEventlocationsResponse, PostApiManagerEventlocationsResponse, PostApiManagerEventlocationsRegisterResponse, PutApiManagerEventlocationsByIdResponse, GetApiManagerEventsResponse, PostApiManagerEventsResponse, PutApiManagerEventsByIdResponse, GetApiManagerReservationAllowanceResponse, PostApiManagerReservationAllowanceResponse, GetApiManagerReservationAllowanceEventByEventIdResponse, GetApiManagerReservationAllowanceByIdResponse, GetApiManagerReservationsResponse, PostApiManagerReservationsResponse, GetApiManagerReservationsEventByIdResponse, GetApiManagerReservationsByIdResponse, PutApiManagerReservationsByIdResponse, GetApiManagerSeatsResponse, PostApiManagerSeatsResponse, GetApiManagerSeatsByIdResponse, PutApiManagerSeatsByIdResponse, GetApiUserEventsResponse, GetApiUserReservationsResponse, PostApiUserReservationsResponse, GetApiUserReservationsByIdResponse, PostApiUsersAdminResponse, GetApiUsersAdminByIdResponse, PutApiUsersAdminByIdResponse, GetApiUsersManagerResponse, GetApiUsersMeResponse, PutApiUsersMeResponse } from './types.gen';
...
export const postApiManagerEventlocationsRegisterResponseTransformer = async (data: any): Promise<PostApiManagerEventlocationsRegisterResponse> => {
    data = eventLocationResponseDtoSchemaResponseTransformer(data);
    return data;
};
...
export const postApiUsersAdminResponseTransformer = async (data: any): Promise<PostApiUsersAdminResponse> => {
    data = userDtoSchemaResponseTransformer(data);
    return data;
};

export const getApiUsersAdminByIdResponseTransformer = async (data: any): Promise<GetApiUsersAdminByIdResponse> => {
    data = userDtoSchemaResponseTransformer(data);
    return data;
};
